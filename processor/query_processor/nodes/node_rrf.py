...
class NodeRrf(NodeBase):
    ...
    def process(self, state: QueryGraphState) -> QueryGraphState:
        ...
        embedding_search_list = [doc.get("entity") for doc in (state.get("embedding_chunks") or []) if isinstance(doc,dict)]
        hyde_embedding_search_list = [doc.get("entity") for doc in (state.get("hyde_embedding_chunks") or []) if isinstance(doc,dict)]
